import { ACCOUNT_CLIENT_CONFIG } from '@/constants/account-api';
...
/**
 * 账号管理 HTTP 客户端
 * 通过 Next.js API 路由代理访问 sciTigerSpider API
 */
class AccountHttpClient {
  private baseURL: string;

  constructor() {
    this.baseURL = ACCOUNT_CLIENT_CONFIG.BASE_URL;
  }
...
// 创建全局实例
export const accountHttp = new AccountHttpClient();
